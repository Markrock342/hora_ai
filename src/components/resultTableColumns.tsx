...
import type { HouseTableRow, PlanetTableRow, TaksaTableRow } from '../types/astrology'
...
/** ตารางย่อ 2 คอลัมน์ (ดาวหลัก 10 ดวง) */
export const PLANET_SIGN_COLUMNS: Column<{ planet: string; siderealSign: string }>[] = [
  {
    key: 'planet',
    header: 'ดาว',
